...
bess_impact_rate = 0.91 + 0.74  # \uc0\u8377 /unit baseline charge\
...
\
# Display Metrics\
st.title(f"\uc0\u55357 \u56522  Extension Opportunities for \{client\}")\
...
\})\
\
st.subheader("\uc0\u55357 \u56520  ROI Comparison")\
